...
public class CameraFollow : MonoBehaviour
{
    ...
    private float smoothDampVelocity = Vector3.zero.x;
    ...
    void Start()
    {
        ...
        levelMinX = leftBounds.position.x - 12.5f + leftBoundWidth + (camWidth / 2);
        levelMaxX = rightBounds.position.x - 40 + rightBoundWidth + (camWidth / 2);
    }
